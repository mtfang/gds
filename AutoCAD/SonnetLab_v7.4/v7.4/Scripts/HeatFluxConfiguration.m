...
classdef HeatFluxConfiguration < handle
    % This class defines the settings to be used for a current data export
    %
    % Usage:
    %
    %   HeatFluxConfiguration(theFilename,theLabel,theRegion,thePorts,theFrequency,theGridX,theGridY)
    ...
    %   theRegion is [] then the currents for the entire layout will be outputted. thePorts should be a vector of JXYPort
    ...
    %
    %
    %   HeatFluxConfiguration(theFilename,theLabel,theRegion,thePorts,...
    ...
    %
    %
    %   HeatFluxConfiguration(theFilename,theLabel,theRegion,thePorts,theFrequency,...
    ...
    %
    % Examples:
    %   HeatFluxConfiguration('Export1.csv','Iteration 1',[],p1,1e9,5,5)
    %   HeatFluxConfiguration('Export2.csv','Iteration 2',Rectange,[p1 p2],[1e9 10e9],0,5,5,true,'X1',1.1)
    %   HeatFluxConfiguration('Export3.csv','Iteration 3',Line,[p1 p2],[1e9 10e9],1,5,5,true,strvcat('X1','X2'),[1.1 1.2])
    %
    % See also JXYRequest
    ...
    methods
        ...
        function obj=HeatFluxConfiguration(theFilename,theLabel,theRegion,thePorts,theFrequency,...
                theGridX,theGridY,theLevel,theComplex,theParameterName,theParameterValue)
        ...
        function write(obj,theFilename)
            ...
            theDom = com.mathworks.xml.XMLUtils.createDocument('JXY_Export_Set');
