...
# FEEDLINE - Padding
cpwfeed2 = gdslib.CPWPath(1e-9,304,layer = 8, cellName = device)
cpwfeed2.start([1125 + 150,100+50],'+y')
cpwfeed2.openGapFillet(150,'beg')
cpwfeed2.straight(250)
cpwfeed2.straight(250, widthEnd = 1e-9, gapEnd = 14)
cpwfeed2.straight(3500)
cpwfeed2.bend(250, 'r')
cpwfeed2.straight(2000)
cpwfeed2.bend(250, 'r')
cpwfeed2.straight(3000)
cpwfeed2.bend(250, 'l')
cpwfeed2.straight(2000)
cpwfeed2.bend(250, 'l')
cpwfeed2.straight(3000)
cpwfeed2.bend(250, 'r')
cpwfeed2.straight(1950)
cpwfeed2.bend(250, 'r')
cpwfeed2.straight(3500)
cpwfeed2.straight(250, widthEnd = 1e-9, gapEnd = 304)
cpwfeed2.straight(250)
cpwfeed2.openGapFillet(150,'end')
cpwfeed2.end()
...
for i in range(0,3):
    for j in range(0,3):
        ...
        bendRad = 150
        meanderLen = totalLength - openDis - capDist - cpwSrtExtend - pi*bendRad
        cpw = gdslib.CPWPath(1e-9,(widths[idx] +2*gaps[idx])/2 + 4 ,layer = 8, cellName = device)
        cpw.start([1125 + 150 + distOffset + 2500*i,1900  + 1100*j],'+y')
        cpw.openGap(openDis)
        cpw.straight(capDist)
        cpw.bend(bendRad, 'r')
